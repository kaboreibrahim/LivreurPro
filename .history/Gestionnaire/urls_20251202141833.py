...
urlpatterns = [
    ...
    path('gestionnaire/api/livreur-positions/', get_livreur_positions, name='get_livreur_positions'),

    path('gestionnaire/livreurs/', LivreurDisponible.as_view(), name='livreur_disponible'),
