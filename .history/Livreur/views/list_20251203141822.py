...
class DemandeLivreurListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        try:
            livreur = Livreur.objects.get(user=self.request.user)
        ...
        queryset = DCL.objects.filter(coursier=livreur)
    ...
    def get_context_data(self, **kwargs):
        ...
        if hasattr(self.request.user, 'livreur'):
            ...
            context['total_demandes'] = DCL.objects.filter(livreur=livreur).count()
