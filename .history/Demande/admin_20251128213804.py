...
class DCLAdmin(admin.ModelAdmin):
    list_display = (
        'ref', 'client', 'nom_client', 'numero_client', 'adresse_depart', 'adresse_destination',
    ...
    search_fields = ('ref', 'client__username', 'nom_client', 'numero_client', 'adresse_depart', 'adresse_destination')
    ...
    fieldsets = (
        (None, {
            'fields': ('ref', 'client', 'nom_client', 'numero_client', 'coursier', 'statut')
        }),
        ('Lieux', {
            'fields': (
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not obj.ref:
            obj.ref = f'DC-{uuid.uuid4().hex[:8].upper()}'
