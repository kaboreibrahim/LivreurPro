...
class DCL(SafeDeleteModel, LifecycleModel):
    ...
    STATUT_CHOICES = [
            ...
            ('VALIDATION_CLIENT', '  Prix validé par le client'),
            ('VALIDATION_LIVREUR', ' Validation livreur'),
            ('LIVREUR_ROUTE', ' Livreur en route pour récupération du colis'),
            ('RECEPTION_COLIS', ' Récupération du colis'),
            ('LIVRAISON_EN_ROUTE', ' Livraison en route'),
            ('TERMINEE', ' Livrée'),
            ('ANNULEE', ' Annulée'),
        ]
    ...
    def get_roadmap_html(self):
        ...
        etapes = [
            ...
            ('VALIDATION_CLIENT', 'Validation client', 'En attente de validation du prix par le gestionnaire.'),
