...
def creer_demande_livraison(request):
    ...
    if request.method == 'POST':
        form = DCLForm(request.POST, request.FILES)  # Assurez-vous que request.FILES est bien passé
        ...
        if form.is_valid():
            ...
            if 'photo_colis1' in request.FILES:
                demande.photo_colis1 = request.FILES['photo_colis1']
            if 'photo_colis2' in request.FILES:
                demande.photo_colis2 = request.FILES['photo_colis2']
